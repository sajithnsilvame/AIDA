...
use App\Services\Tenant\Export\VariantAttributeExportService;

class AttributeExportController extends Controller
{
    public function __construct(VariantAttributeExportService $service)
    {
    ...
    public function index()
    {
        ...
        if ($count >= $export_count) {
            return view('tenant.product.attribute.chunks', [
