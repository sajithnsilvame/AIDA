...
class InternalTransferFilter extends FilterBuilder
{
    ...
    public function branchWarehouseFromId($branch_or_warehouse_id = null)
    {
        $this->builder->when($branch_or_warehouse_id, function (Builder $builder) use ($branch_or_warehouse_id) {
            $builder->where('branch_or_warehouse_from_id', $branch_or_warehouse_id);
        });
    }

    public function branchWarehouseToId($branch_or_warehouse_id = null)
    {
        $this->builder->when($branch_or_warehouse_id, function (Builder $builder) use ($branch_or_warehouse_id) {
            $builder->where('branch_or_warehouse_to_id', $branch_or_warehouse_id);
        });
    }
